...
TOOLS_ROOT = PROJECT_ROOT / "tools" / "avatar_agent"
sys.path.insert(0, str(ROOT))
sys.path.insert(0, str(SRC_ROOT))
sys.path.insert(0, str(TOOLS_ROOT))

from avatar_system.export_gaussian_video import prepare_camera_from_three, prepare_camera_from_three_payload  # noqa: E402
